...
at a negative address, though.)  The computer should have support for large
numbers. Some instructions near the beginning of the BOOST program will verify
this capability.  Here are some example programs that use these features:
...
pub fn run() -> utils::ProblemResult<()> {
    let program = Program::for_problem(9)?;
